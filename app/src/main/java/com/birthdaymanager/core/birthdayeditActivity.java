...
public class birthdayeditActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_birthdayedit);
        initDatePicker();
    ...
    public void popTimePicker(View view)
    {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(this,R.style.themetimePicker,onTimeSetListener, hour, minute, true);
